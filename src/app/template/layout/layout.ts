...
export class Layout implements OnInit {
  ...
  menuItems = [
    ...
    },
    {
      ...
      isSubMenu: true,
      children: [
        { title: 'Novo Cliente', link: '/cadastrar/pessoa' },
        { title: 'Lista de Clientes', link: '/consultar/pessoas' },
      ],
    },
    {
      title: 'Imóveis',
      ...
      isSubMenu: true,
      children: [
        { title: 'Novo Imóvel', link: '/cadastrar/cadimovel' },
  ...
  @Input() props: LayoutProps = {
    titulo:
      'Gerencie contratos de locação em uma plataforma imobiliária completa',
