...
import { CPF_CONTROL_NAME, CNPJ_CONTROL_NAME } from './cad-pessoa.constants';
import { rgValidator } from '../../../validators/rg-validator';
import { emailValidator } from '../../../validators/email-validator';



export function criarFormularioPessoa(fb: FormBuilder) {
  return fb.group({
    tipo: ['PF', Validators.required],
    [CPF_CONTROL_NAME]: [''], // Usando a constante
    [CNPJ_CONTROL_NAME]: [''], // Usando a constante
    rg: ['', [rgValidator()]],
